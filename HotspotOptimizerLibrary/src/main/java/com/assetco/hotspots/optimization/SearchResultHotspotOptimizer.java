...
public class SearchResultHotspotOptimizer {
  ...
  private final RelationshipBasedOptimizer relationshipBasedOptimizer =
      new RelationshipBasedOptimizer();
  ...
  public void setAssessments(AssetAssessments assessments) {
